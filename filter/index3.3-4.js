...
//     });
// };
// console.log(filterRatings(movies, 8));
...
// 3.5
const filterRatingsAndRunTime2 = (arr, rating, runTime) => {
  const movieResults = arr.filter((movie) => {
    return movie.rating.average > rating && movie.runtime <= runTime;
  });
...
console.log(filterRatingsAndRunTime2(movies, 7, 60));